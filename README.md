...
This will return the following runtime images with the following names: `action-nodejs-v18-custom-port`, and `action-nodejs-v20-custom-port`.
...
docker tag action-nodejs-v18-custom-port localhost:5000/action-nodejs-v18-custom-port
docker push localhost:5000/action-nodejs-v18-custom-port

sudo SINGULARITY_NOHTTPS=1 singularity build nodejs18action.simg nodejs18action-singularity.def
```
